...
public class BuyActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //yearly expenses
        final RelativeLayout loYearlyTitle   = (RelativeLayout) findViewById(R.id.actBuy_layoutYearlyTitle);
    	final RelativeLayout loYearlyContent = (RelativeLayout) findViewById(R.id.actBuy_layoutYearlyContent);
    	final ImageView      imgYearlyArrow  = (ImageView) findViewById(R.id.actBuy_imageYearlyArrow);
        ...
        //peripheral expenses
        final RelativeLayout loPeriTitle   = (RelativeLayout) findViewById(R.id.actBuy_layoutPeriTitle);
    	final RelativeLayout loPeriContent = (RelativeLayout) findViewById(R.id.actBuy_layoutPeriContent);
    	final ImageView      imgPeriArrow  = (ImageView) findViewById(R.id.actBuy_imagePeriArrow);
